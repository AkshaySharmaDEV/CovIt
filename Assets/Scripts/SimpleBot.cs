...
public class SimpleBot : MonoBehaviour
{
    ...
    {
        Runnable.Run(ProcessChat(externalInputField.text));
        externalInputField.text = "";
        
    }
    public void one()
    {
        externalInputField.text = "Book my vaccine appointment";
    }
    public void two()
    {
        externalInputField.text = "I am feeling unwell";
    }
    public void three()
    {
        externalInputField.text = "What is vaccine";
    }
    public void four()
    {
        externalInputField.text = "What is covid";
    }
    public void five()
    {
        externalInputField.text = "Are u a bot";
    }
    public void six()
    {
        externalInputField.text = "Plese transfer me to an agent";
    }
